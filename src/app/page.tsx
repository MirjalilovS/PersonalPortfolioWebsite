...
const experiences = [
  {
    ...
    company: "Moneff - Bootstrapepd Fintech Startup",
    description: "During this fintech internship, I gained comprehensive, hands-on experience across the full software lifecycle. I honed my backend development skills through coding, debugging, pair programming and basic database operations, while also developing a practical understanding of modern DevOps practices like CI/CD workflows, containerization, and system monitoring. Working within a fast-paced, agile, and cross-functional team was instrumental in sharpening my collaboration, communication, and problem-solving abilities. I had two mentors who allowed me to get stuck in from day one and greatly accelerated my development as a Software Engineer.",
